...
export default function HomePageClient({ featuredProperties, cities }: HomePageClientProps) {
            ...
            <div className="relative bg-blue-700 h-[500px]">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white">
                    ...
                    <form
                        ...
                        className="bg-white p-4 rounded-lg shadow-lg w-full max-w-5xl flex flex-col md:flex-row gap-4"
                    >
                        <input
                            type="text"
                            value={searchTerm}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <Link key={cat.id} href={`/listings?category=${cat.id}`} className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition text-center cursor-pointer block">
